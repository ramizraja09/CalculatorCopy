...
export default function AboutPage() {
  return (
    <div className="container max-w-4xl mx-auto p-4 md:p-8">
      <Card>
        <CardHeader>
          <CardTitle className="font-headline text-3xl md:text-4xl">About top100calculators</CardTitle>
        </CardHeader>
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            Welcome to top100calculators, your go-to source for a wide array of free, user-friendly online calculators. Our mission is to provide clean, fast, and accessible tools for everyone, covering everything from finance and health to math and everyday life.
          </p>
          ...
          <ul className="list-disc pl-6 space-y-2">
            ...
            <li><strong>Data-Driven Selection:</strong> The "Top 100" calculators were chosen based on extensive research into the most commonly searched and used online calculation tools.</li>
          </ul>

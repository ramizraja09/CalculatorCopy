    ...
    <div className="container max-w-4xl mx-auto p-4 md:p-8">
      <Card>
        ...
        <CardContent className="space-y-4 text-muted-foreground">
          <p>
            top100calculators is committed to ensuring digital accessibility for people with disabilities. We are continually improving the user experience for everyone and applying the relevant accessibility standards.
          </p>
          ...
          <p>
            top100calculators is partially conformant with WCAG 2.2 level AA. Partially conformant means that some parts of the content do not fully conform to the accessibility standard. We are actively working to achieve full conformance.
          </p>
          ...
          <p>
            We welcome your feedback on the accessibility of top100calculators. Please let us know if you encounter accessibility barriers:
          </p>
          <p>
            E-mail: <a href="mailto:feedback@top100calculators.com" className="text-primary hover:underline">feedback@top100calculators.com</a>
          </p>
          <p>

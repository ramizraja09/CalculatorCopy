        ...
        {unit === 'imperial' && (
          <div className="grid grid-cols-2 gap-4">
            <div>
                ...
                <Controller name="heightFt" control={control} render={({ field }) => <Input id="heightFt" type="number" {...field} onChange={e => field.onChange(e.target.value === '' ? '' : parseInt(e.target.value, 10))} />} />
            </div>
             <div>
                <Label htmlFor="heightIn">Height (in)</Label>
                <Controller name="heightIn" control={control} render={({ field }) => <Input id="heightIn" type="number" {...field} onChange={e => field.onChange(e.target.value === '' ? '' : parseInt(e.target.value, 10))} />} />
            </div>
             <div className="col-span-2">
                <Label htmlFor="weightLbs">Weight (lbs)</Label>
                <Controller name="weightLbs" control={control} render={({ field }) => <Input id="weightLbs" type="number" {...field} onChange={e => field.onChange(e.target.value === '' ? '' : parseFloat(e.target.value))} />} />
            </div>
          </div>
        )}
        ...
        {unit === 'metric' && (
           <div className="space-y-4">
            <div>
                ...
                <Controller name="heightCm" control={control} render={({ field }) => <Input id="heightCm" type="number" {...field} onChange={e => field.onChange(e.target.value === '' ? '' : parseFloat(e.target.value))} />} />
            </div>
            <div>
                <Label htmlFor="weightKg">Weight (kg)</Label>
                <Controller name="weightKg" control={control} render={({ field }) => <Input id="weightKg" type="number" {...field} onChange={e => field.onChange(e.target.value === '' ? '' : parseFloat(e.target.value))} />} />
            </div>
          </div>
        )}
